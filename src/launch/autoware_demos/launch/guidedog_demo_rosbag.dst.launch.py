...
def generate_launch_description():
    ...
    # Planning Nodes
    ###############################
    global_planner_node_runner = Node(
        name='gaode_api_global_planner_node',
        namespace='planning',
        package='gaode_api_global_planner_nodes',
        executable='gaode_api_global_planner_node_exe',
        output='screen',
        remappings=[('cur_pose', '/localization/cur_pose'),
    ...
    behavior_planner = Node(
        ...
        output='screen',
        remappings=[
            ('vehicle_state', '/localization/vehicle_kinematic_state'),    
            ('route', '/planning/global_path'),
    ...
    global_path_mapping = Node(
        ...
        namespace='planning',
        parameters=[{'len_forward_per_step': 2.0}]
    )
