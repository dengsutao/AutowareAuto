...
from benchmark_tool.output_formatter.segmentation_node_output_formatter \
    import SegmentationNodeOutputFormatter
...
class EuclideanClusterNodeTask(BenchmarkTask):
    ...
    def init(self):
        ...
        # Load the segmentation output formatter to get the output of
        # the lidar node and translate it to the kitti format
        self._output_formatter = SegmentationNodeOutputFormatter(
            self.node,
