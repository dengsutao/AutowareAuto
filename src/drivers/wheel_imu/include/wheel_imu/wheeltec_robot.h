...
{
	public:
        turn_on_robot(std::string name);
        fish_protocol::ProtocolConfig proto_config;
        void Receive_STM32_Data(const std::string &data);
        void Set_Last_Time(rclcpp::Time t);
	private:
        std::shared_ptr<fish_protocol::FishProtocol> protocol;
        // rclcpp::Node n; //
        ...
        rclcpp::Subscription<std_msgs::msg::UInt32>::SharedPtr reset_odom_sub;
        void Reset_Odom_Callback(const std_msgs::msg::UInt32::SharedPtr value); 
